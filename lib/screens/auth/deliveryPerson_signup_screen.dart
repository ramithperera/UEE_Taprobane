...
class DeliveryPersonSignUp extends StatefulWidget {
  DeliveryPersonSignUp({Key? key}) : super(key: key);

  @override
  State<DeliveryPersonSignUp> createState() => _DeliveryPersonSignUpState();
}

class _DeliveryPersonSignUpState extends State<DeliveryPersonSignUp> {
                      ...
                      child: Center(
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            textInputAction: TextInputAction.next,
                            decoration: const InputDecoration(
                              hintText: "Please enter your vehicle Type",
                              // labelText: "Email address",
                              border: InputBorder.none,
                              // labelStyle: TextStyle(
                              //   color: colorOrange
                      ...
                      child: Center(
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            textInputAction: TextInputAction.next,
                            decoration: const InputDecoration(
                              hintText: "Please enter your Vehicle Number",
                              // labelText: "Email address",
                              border: InputBorder.none,
                              // labelStyle: TextStyle(
                              //   color: colorOrange
  ...
  void register() async {
    ...
    if (vehicleTypeController.text.isEmpty) {
      showToastMessage('Vehicle Type cannot be empty!');
    }
    if (vehicleNumberController.text.isEmpty) {
      showToastMessage('Vehicle Number cannot be empty!');
    }
