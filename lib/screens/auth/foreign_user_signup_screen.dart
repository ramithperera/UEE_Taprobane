...
class ForeignUserSignUp extends StatefulWidget {
  ForeignUserSignUp({Key? key}) : super(key: key);

  @override
  State<ForeignUserSignUp> createState() => _ForeignUserSignUpState();
}

class _ForeignUserSignUpState extends State<ForeignUserSignUp> {
